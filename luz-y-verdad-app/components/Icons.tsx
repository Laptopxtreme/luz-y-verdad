...
export const PrayingHandsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M18 16.8l-5.17-5.17a1.37 1.37 0 0 0-2.33.32l-3.32 6.64a1.37 1.37 0 0 0 1.63 1.95l6.64-3.32a1.37 1.37 0 0 0 .32-2.33Z"/>
        <path d="m14 18.2-3.32-3.32a1.37 1.37 0 0 0-1.94 0l-4.24 4.24a1.37 1.37 0 0 0 0 1.94l1.41 1.41a1.37 1.37 0 0 0 1.94 0l4.24-4.24a1.37 1.37 0 0 0 0-1.94Z"/>
    </svg>
);
